// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/tabulator-tables/index.d.ts
...
You can pass an optional additional property with sorter, sorterParams that should contain an object with additional information for configuring the sorter*/
  ...
  type ColumnSorterParamLookupFunction = (
    column: ColumnComponent,
    dir: SortDirection
  ) => {};
...
declare class Tabulator {
  ...
  downloadToTab: (
    downloadType: Tabulator.DownloadType,
    fileName: string,
    params?: Tabulator.DownloadOptions
  ) => void;
...
*/
  ...
  getRows: (
    activeOnly?: Tabulator.VisibleRowRangeLookup
  ) => Tabulator.RowComponent[];
  ...
  */
   ...
   */
  getColumns: (
    includeColumnGroups?: boolean
  ) => Tabulator.ColumnComponent[] | Tabulator.GroupComponent[];
 ...
 */
  ...
  moveColumn: (
    fromColumn: Tabulator.ColumnLookup,
    toColumn: Tabulator.ColumnLookup,
    after: boolean
  ) => void;
...
*/
  ...
  setSort: (
    sortList: string | Tabulator.Sorter[],
  ...
  */
  ...
  selectRow: (
    lookup?: Tabulator.RowLookup[] | 'all' | 'active' | 'visible' | true
  ) => void;
